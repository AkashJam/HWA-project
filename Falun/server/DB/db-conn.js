...
async function insertFakeData() {
    ...
    const firstUser = await User.create({
        ...
        profilePicture: 'https://cdn.shopify.com/s/files/1/0045/5104/9304/t/27/assets/AC_ECOM_SITE_2020_REFRESH_1_INDEX_M2_THUMBS-V2-1.jpg?v=8913815134086573859',
    })
    const secondUser = await User.create({
        ...
        profilePicture: 'https://img.freepik.com/free-photo/portrait-confident-beautiful-brunette-woman-turning-face-camera-with-dreamy-look-white_1258-19144.jpg?size=626&ext=jpg',
    })
    const thirdUser = await User.create({
        ...
        profilePicture: 'https://netstorage-tuko.akamaized.net/images/7837e1645580ee67.jpg?&imwidth=1200',
    })
    const fourthUser = await User.create({
        ...
        userRole: 'Hacker',
        profilePicture: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8d29tYW58ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80',
    })
    const fifthUser = await User.create({
        ...
        userRole: 'Web Developer',
        profilePicture: 'https://www.aero-mag.com/wp-content/uploads/2019/07/AMJuly19News-ametek1-e1563205327354-1024x1024.jpg',
    })
    const sixthUser = await User.create({
        ...
        userRole: 'Web Developer',
        profilePicture: 'https://www.lifespan.org/sites/default/files/styles/media_card/public/2020-11/Lifespan-images-12_0.jpg?h=10d202d3&itok=34u2dgSw',
    })
    const seventhUser = await User.create({
        ...
        userRole: 'Web Designer',
        profilePicture: 'https://ichef.bbci.co.uk/news/976/cpsprodpb/FD27/production/_101970846_aubreyblanche.jpg',
    })
    const eighthUser = await User.create({
        ...
        userRole: 'Hacker',
        profilePicture: 'https://media.istockphoto.com/photos/portrait-of-casual-smiling-man-picture-id1138562953?k=6&m=1138562953&s=612x612&w=0&h=FzSLV-RtbFTz7z_VCbmuSCfEWpd4kYbnPxZ5d_mdDgg=',
    })
    const ninthUser = await User.create({
        ...
        userRole: 'Data Scientist',
        profilePicture: 'https://ak.picdn.net/shutterstock/videos/4862444/thumb/1.jpg',
    })
    ...
    const eleventhUser = await User.create({
        ...
        profilePicture: 'https://ak.picdn.net/shutterstock/videos/24960599/thumb/1.jpg',
    })
    const twelvethUser = await User.create({
        ...
        profilePicture: 'https://images.idgesg.net/images/article/2020/01/women-in-it_daphne-jones-100828118-large.jpg',
    })
    const thirteenthUser = await User.create({
        ...
        profilePicture: 'https://dentelle.co.uk/wp-content/uploads/2016/02/botox-for-men.jpg',
    })
    const fourteenthUser = await User.create({
        ...
        profilePicture: 'https://images.vanityfair.it/wp-content/uploads/2021/02/05152837/GettyImages-1186179742-4.jpg',
    })
    ...
    const service1 = await Service.create({
        ...
        image: 'https://www.studioideagrafica.it/wp-content/uploads/2016/08/la-figura-del-web-designer.jpg',
    })
    const service2 = await Service.create({
        name: 'DevOps & Maintainance',
        description: 'Deployment and Database Maintainance for websitew',
        image: 'https://d210waafu5nnsw.cloudfront.net/fad1ff76-801d-4adb-be70-9ddfacfeda88/images/u086a4ff5217_original_opt.jpeg',
    })
    const service3 = await Service.create({
        name: 'Dashboards',
        description: 'Creating beautiful and insightful dashboards for your enterprise',
        image: 'https://blog.trello.com/hs-fs/DashboardFinal.png',
    })
    const service4 = await Service.create({
        name: 'Recommender Systems',
        description: 'Provide intelligent recommendations to users based on their interests and actions',
        image: 'https://ourcodeworld.com/public-media/articles/articleocw-5e02cb556727f.webp',
    })
    const service5 = await Service.create({
        name: 'Trend Analysis',
        description: 'Analyze market trends to create strategies and for development and marketing',
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyKGC74fg7x9rF7akCp9qhHG6LjeZd8I2gAiyKJxrQlbrf8IicevCan93lh-aeIof37qM&usqp=CAU',
    })
